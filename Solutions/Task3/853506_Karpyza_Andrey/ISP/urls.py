...
from django.contrib.auth.views import LogoutView, logout_then_login, PasswordResetView, \
    PasswordResetDoneView, PasswordResetConfirmView, PasswordResetCompleteView, PasswordChangeView, PasswordChangeDoneView
from DjangoChat.forms import LoginRequiredView
...
urlpatterns = [
    ...
    path('login/',  LoginRequiredView.as_view(),  name='login'),
    ...
    url(r'^register/confirmation/(?P<key>[-\w]+)$', views.register_confirm, name='post_share'),
